...
1. **AgentPoison: Red-teaming LLM Agents via Poisoning Memory or Knowledge Bases** ( NeurIPS 2024 )

- 论文地址：https://doi.org/10.52202/079017-4136
- 代码地址：https://github.com/AI-secure/AgentPoison
...
2. **Unveiling Privacy Risks in LLM Agent Memory** ( ACL 2025 )

- 论文地址：https://doi.org/10.18653/v1/2025.acl-long.1227
- 代码地址：https://github.com/wangbo9719/MEXTRA
...
3. **Memory Injection Attacks on LLM Agents via Query-Only Interaction** ( NeurIPS 2025 )

- 论文地址：https://neurips.cc/virtual/2025/loc/san-diego/poster/118152
- 代码地址：https://github.com/dsh3n77/MINJA
...
4. **A-MemGuard: A Proactive Defense Framework for the LLM-based Agent Memory** ( arXiv 2025 )

- 论文地址：https://arxiv.org/abs/2510.02373
- 代码地址：https://github.com/TangciuYueng/AMemGuard
...
5. **From Storage to Steering: Memory Control Flow Attacks on LLM Agents** ( arXiv 2026 )

- 论文地址：https://arxiv.org/abs/2603.15125
- 代码地址：暂无
...
6. **ADAM: A Systematic Data Extraction Attack on Agent Memory via Adaptive Querying** ( OpenReview 2026 )

- 论文地址：https://openreview.net/forum?id=9H1nu8Z6Uy
- 代码地址：暂无
